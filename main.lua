...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/alnicke/alnicke/main/uifluxus"))()

-- ESP support
local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/alnicke/alnicke/main/esp"))()
